  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        floatingActionButton: (_activePageIndex == 0)
            ? FloatingActionButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const AddPlantView(),
                    ),
                  );
                },
              ...
              decoration: BoxDecoration(
                ...
                */
                image: const DecorationImage(
                  image: AssetImage('placeholders/plant_placeholder.jpg'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Provider.of<UserData>(context, listen: false).addPlant(UserPlantData(
